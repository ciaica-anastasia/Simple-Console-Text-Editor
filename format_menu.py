...
def main(root, text, menubar):
    ...
    formatMenu.add_command(label="Change Overall Font Color", command=objFormat.changeFg)
    formatMenu.add_cascade(label="Overall Font", underline=0, menu=fsubmenu)
    formatMenu.add_cascade(label="Overall Size", underline=0, menu=ssubmenu)
